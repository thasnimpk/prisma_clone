...
import img56 from "../../src/assets/w1.jpg";
import img57 from "../../src/assets/w2.jpg";
import img58 from "../../src/assets/w3.jpg";
import img59 from "../../src/assets/w4.jpg";
import img60 from "../../src/assets/w5.jpg";
import img61 from "../../src/assets/w6.jpg";
import img62 from "../../src/assets/wa1.jpg";
import img63 from "../../src/assets/wa2.jpg";
import img64 from "../../src/assets/wa3.jpg";
import img65 from "../../src/assets/wa4.jpg";
import img66 from "../../src/assets/wa5.jpg";
import img67 from "../../src/assets/wa6.jpg";
import AOS from 'aos';
import 'aos/dist/aos.css';
import img68 from "../../src/assets/h-1.png";
  ...
  return (
    <div className="w-full ">
      ...
      <div className="h-[180px] w-full flex justify-center items-center">
        <h3 className="font-bold text-2xl">Popular for Him</h3>
      </div>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="items-end flex absolute top-0 justify-center w-full h-full">
                ...
                >
                  <img src={img68} className="h-[20px] w-[20px]" alt="icon" />
                </div>
              </div>
            </div>
          ))}
      ...
      <div className='h-[250px] W-full flex justify-center items-center'>
        <button className='bg-gray-100 text-sm w-[240px] rounded-xl h-[55px] text-gray-500 hover:bg-gray-200 transition duration-200'>DISCOVER ALL MEN WATCHES</button>
      </div>
    </div>
  );
}
